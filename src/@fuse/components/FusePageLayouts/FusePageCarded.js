...
class FusePageCarded extends React.Component {
    ...
    render()
    {
        const {classes,settings, mainThemeDark, rightSidebarHeader, rightSidebarContent, rightSidebarVariant, leftSidebarHeader, leftSidebarContent, leftSidebarVariant, header, content, contentToolbar, innerScroll} = this.props;
        ...
        const position = layoutConfig.navbar.position;
       // const theme1 = theme.breakpoints;
       //const head = theme.breakpoints; 
        ...
        return (
            <div className={classNames(classes.root, innerScroll && classes.innerScroll)}
                ...
                <div className="flex container w-full"  dir={position =='right' ? 'rtl':'ltr'}>
