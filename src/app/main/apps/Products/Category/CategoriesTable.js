...
class CategoriesTable extends Component {
    ...
    componentDidMount()
    {
        this.props.getCategories(this.props.user.uuid);
    }
    ...
    handleClick = (item) => {
        ...
        this.props.history.push('/apps/category/edit/' + item.id);
    };
...
{
    return {
        categories  : ProductsApp.categories.data,
        searchText: ProductsApp.categories.searchText,
        user : auth.user
    }
}
