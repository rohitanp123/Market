                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" scope="row" style={{'padding-left':'45px'}}>
                                                {n.name}
                                            </TableCell>                                           
                                            ...
                                            <TableCell component="th" scope="row" style={{'padding-left':'15px'}}>
                                            ...
                                            {user && user.role!=='sme' && <TableCell component="th" scope="row" >
                                            { ( (n.approveStatus === 2)?
